...
<figure class="term-fig"><div class="term-grid" style="grid-template-columns: auto repeat(6, 2.2rem);"><span class="lbl">col:</span><span class="lbl">0</span><span class="lbl">1</span><span class="lbl">2</span><span class="lbl">3</span><span class="lbl">4</span><span class="lbl">5</span><span class="lbl">row 0 (y=0)</span><span>H</span><span>i</span><span></span><span></span><span></span><span></span><span class="lbl">row 1 (y=1)</span><span></span><span></span><span></span><span></span><span></span><span></span><span class="lbl">row 2 (y=2)</span><span></span><span></span><span></span><span></span><span></span><span></span></div><figcaption>A six-by-three cell buffer with <code>Hi</code> painted at the top-left; every other slot is a blank cell.</figcaption></figure>
